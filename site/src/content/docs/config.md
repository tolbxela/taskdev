...
and the agent-add allow-list, see [`security.md`](/docs/security). For practical setups, see
[`usage.md`](/docs/usage).
...
| `taskdev_add`          | `name`, `command`, `cwd?`, `env?`, `confirm: "ADD <name>"`, `project?` | Add a task. See [`security.md`](/docs/security) for the allow-list. |
