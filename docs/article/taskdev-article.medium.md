...
*[Image: TaskDev sidebar showing a project node with two tasks - upload Screenshot 2026-05-10 001838.png here]*
...
*[Image: Sidebar with the title-bar Open taskdev.json button next to the open config - upload Screenshot 2026-05-10 001858.png here]*
...
*[Image: Hovering a task row reveals Start task and Show log buttons - upload Screenshot 2026-05-10 001730.png here]*
...
*[Image: Task log open beside the sidebar - upload Screenshot 2026-05-10 001919.png here]*
...
*[Image: Install MCP config picker listing Windsurf, Claude Code, Cursor, Codex, and workspace-scoped configs - upload Screenshot 2026-05-10 001800.png here]*
