...
allow-list and security rules, see [`security.md`](security.md). For the full
`taskdev.json` schema and MCP tools reference, see [`config.md`](config.md).
...
[`security.md`](security.md) for the exact rules.
